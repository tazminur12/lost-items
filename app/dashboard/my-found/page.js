    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Items you have reported as found or recovered.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-xl shadow-sm border border-dashed border-gray-300">
          ...
          <p className="text-gray-500 mb-6">You haven&apos;t posted any found items yet. Help someone by reporting an item you found!</p>
          <Link href="/post-found" className="inline-flex items-center px-5 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-200">
            Post a Found Item
          </Link>
        </div>
      ) : (
